 ...
 */
public class Full3Adapter extends RecyclerView.Adapter<Full3Adapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public Full3Adapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
