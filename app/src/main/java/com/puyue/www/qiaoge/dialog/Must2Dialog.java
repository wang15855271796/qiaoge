...
import com.puyue.www.qiaoge.adapter.NewSpec2Adapter;
 ...
 */
public class Must2Dialog extends Dialog implements View.OnClickListener{
    Context context;
    public View view;
    ...
    private void init() {
        ...
        searchSpecAdapter = new NewSpec2Adapter(context,listBean.getProdSpecs());
