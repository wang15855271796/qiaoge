 ...
 */
public class Menu2ItemAdapter extends BaseAdapter {

    //上下文
    private Context mContext;
    //菜单列表
    private List<AddressBean.DataBean.ListBeanX> mListData;
    ...
    public Menu2ItemAdapter(Context context, List<AddressBean.DataBean.ListBeanX> listData, int sId, int nId) {
        mContext = context;
        mListData = listData;
     ...
     */
    public void setSelectedPositionNoNotify(int pos,List<AddressBean.DataBean.ListBeanX> list) {
        selectedPos = pos;
        mListData = list;
        if (mListData != null && pos < mListData.size()) {
            selectedText = mListData.get(pos).getName();
    ...
    public void setSelectedPositionNoNotifys(int pos,List<AddressBean.DataBean.ListBeanX> list) {
        selectedPos = pos;
        mListData = list;
        if (mListData != null && pos < mListData.size()) {
