 ...
 */
public class ChooseSelfCouponFragment extends BaseFragment {
    ...
    ChooseSelfCouponsAdapter adapter;
    @Override
    public void setViewData() {

        adapter = new ChooseSelfCouponsAdapter(R.layout.item_choose_copons, list, new ChooseSelfCouponsAdapter.ImageOnclick() {
            @Override
