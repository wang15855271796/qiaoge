...
public class MenuButtonTwo extends RelativeLayout {
    ...
    public MenuButtonTwo(Context context) {
        super(context);
    }

    public MenuButtonTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MenuButtonTwo(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rl_root.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(onSelectListener!=null){
                    onSelectListener.onSelect(MenuButtonTwo.this,selected);
                }
    ...
    public void setSelect(boolean selected){
        ...
        if(selected){
            tv_title.setTextColor(mContext.getResources().getColor(R.color.select_title));
           setDrawable(R.mipmap.ic_market_sanjiao);
        }else {
         //   tv_title.setTextColor(mContext.getResources().getColor(R.color.color333333));
            setDrawable(R.mipmap.menu_arrow_bottom);
        }
    }
    /**
     * 设置检讨
