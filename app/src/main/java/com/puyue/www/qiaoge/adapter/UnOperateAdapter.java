 ...
 */
public class UnOperateAdapter extends BaseQuickAdapter<CartBalanceModel.DataBean.ProductVOListBean, BaseViewHolder> {
    ...
    public UnOperateAdapter(int layoutResId, @Nullable List<CartBalanceModel.DataBean.ProductVOListBean> data) {
