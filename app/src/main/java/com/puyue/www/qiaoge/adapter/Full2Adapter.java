 ...
 */
public class Full2Adapter extends RecyclerView.Adapter<Full2Adapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public Full2Adapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        if(activesBean.getSendGiftInfo()!=null) {
            ...
            holder.tv_full_desc.setBackground(null);
