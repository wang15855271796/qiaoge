...
public class MenuItemAdapter extends BaseAdapter {
    ...
    public MenuItemAdapter(Context context, List<AddressBean.DataBean> listData, int sId, int nId) {
        mContext = context;
        mListData = listData;
     ...
     */
    public void setSelectedPositionNoNotify(int pos,List<AddressBean.DataBean> list) {
        selectedPos = pos;
        mListData = list;
        if (mListData != null && pos < mListData.size()) {
            selectedText = mListData.get(pos).getName();
