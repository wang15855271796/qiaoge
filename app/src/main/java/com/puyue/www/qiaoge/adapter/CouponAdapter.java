 ...
 */
public class CouponAdapter extends RecyclerView.Adapter<CouponAdapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public CouponAdapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
