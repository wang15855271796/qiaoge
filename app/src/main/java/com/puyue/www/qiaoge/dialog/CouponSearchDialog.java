...
import com.puyue.www.qiaoge.adapter.CouponSearchSpecsAdapter;
 ...
 */
public class CouponSearchDialog extends Dialog implements View.OnClickListener {
    ...
    public CouponSearchDialog(Context context, ProductNormalModel.DataBean.ListBean item) {
    ...
    private void init() {
        ...
        searchSpecAdapter = new CouponSearchSpecsAdapter(context,listBean.getProdSpecs());
