...
public class MenuBarTwo extends LinearLayout implements PopupWindow.OnDismissListener {
    ...
    public MenuBarTwo(Context context) {
        super(context);
    }

    public MenuBarTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public MenuBarTwo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void startAnimation() {
        if (popupWindow == null) {
            popupWindow = new SupportPopupWindow(mPupViewList.get(selectPosition), displayWidth, displayHeight);
