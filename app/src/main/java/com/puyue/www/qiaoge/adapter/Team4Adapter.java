 ...
 */
public class Team4Adapter extends RecyclerView.Adapter<Team4Adapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public Team4Adapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
