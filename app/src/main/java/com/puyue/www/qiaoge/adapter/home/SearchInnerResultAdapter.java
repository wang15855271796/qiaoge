...
class SearchInnerResultAdapter extends BaseQuickAdapter<SearchResultsModel.DataBean.SearchProdBean.ListBean.ProdPricesBean,BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, SearchResultsModel.DataBean.SearchProdBean.ListBean.ProdPricesBean item) {
