 ...
 */
public class CommonProductItemAdapter extends BaseQuickAdapter<ExchangeProductModel.DataBean.ProdPricesBean,BaseViewHolder> {
    ...
    public CommonProductItemAdapter(int businessType,int productId,int layoutResId, @Nullable List<ExchangeProductModel.DataBean.ProdPricesBean> data) {
                                    ...
                                    .subscribe(new Subscriber<AddCartGoodModel>() {
                                        ...
                                        public void onNext(AddCartGoodModel addMountReduceModel) {
                                            ...
                                            if (addMountReduceModel.isSuccess()) {
                                                ...
                                                alertDialog.dismiss();
                                                EventBus.getDefault().post(new UpDateNumEvent4());
