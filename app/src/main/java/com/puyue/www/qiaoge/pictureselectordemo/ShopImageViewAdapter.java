package com.puyue.www.qiaoge.pictureselectordemo;
 ...
 */
public class ShopImageViewAdapter extends RecyclerView.Adapter<ShopImageViewAdapter.ViewHolder>{
    ...
    public void setLists(List<String> pictureList) {
