...
/**
 * Created by Sai on 15/8/9. 精仿iOSAlertViewController控件 点击取消按钮返回 －1，其他按钮从0开始算
 */
public class AlertView {
	...
	public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context,
	...
	protected void initViews() {
		...
		case ActionSheet:
			...
			margin_alert_left_right = context.getResources()
					.getDimensionPixelSize(R.dimen.margin_actionsheet_left_right);
	...
	protected void initActionSheetViews(LayoutInflater layoutInflater) {
		ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_actionsheet,
				contentContainer);
