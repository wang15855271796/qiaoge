 ...
 */
public class SearchItem1Adapter extends BaseQuickAdapter<ExchangeProductModel.DataBean.ProdPricesBean,BaseViewHolder> {
                                    ...
                                    .subscribe(new Subscriber<AddCartGoodModel>() {
                                        ...
                                        public void onNext(AddCartGoodModel addMountReduceModel) {
                                            ...
                                            if (addMountReduceModel.isSuccess()) {
                                                ...
                                                alertDialog.dismiss();
                                                EventBus.getDefault().post(new UpDateNumEvent8());
                                            } else {
