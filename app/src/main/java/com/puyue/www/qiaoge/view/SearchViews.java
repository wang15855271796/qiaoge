 ...
 */
public class SearchViews extends LinearLayout implements View.OnClickListener{
    ...
    public SearchViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.search_layouts, this);
        initViews();
    }
