        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    } else if (mFlingView.getChildCount() == 3) {

                        mMenuViewWidth = mFlingView.getChildAt(1).getWidth() + mFlingView.getChildAt(2).getWidth();

                    } else if (mFlingView.getChildCount() == 4) {
                        mMenuViewWidth = mFlingView.getChildAt(1).getWidth() + mFlingView.getChildAt(2).getWidth() + mFlingView.getChildAt(3).getWidth();
                    } else if (mFlingView.getChildCount() == 5) {
                        mMenuViewWidth = mFlingView.getChildAt(1).getWidth() + mFlingView.getChildAt(2).getWidth() + mFlingView.getChildAt(3).getWidth() + mFlingView.getChildAt(4).getWidth();
                    } else {
