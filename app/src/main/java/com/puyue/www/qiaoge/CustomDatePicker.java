...
public class CustomDatePicker {
    ...
    List<String> mlist;
    public CustomDatePicker(List<String> mlist, Context context, ResultHandler resultHandler) {
    ...
    private void initView() {
        RecyclerView recyclerView =(RecyclerView) datePickerDialog.findViewById(R.id.recyclerView);
...
//        TimeAdapter timeAdapter = new TimeAdapter(R.layout.item_text,mlist);
...
//                    setSelectedTime(time);
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            String[] dateStr = str[0].split("-");//年月日
     ...
     * 初始显示时是否将月份显示全
     *
     * @param monthClear true从1月-12月都显示   false从指定的月份开始显示
     */
    public void setMonthClear(boolean monthClear) {
        this.monthClear = monthClear;
    }

    /**
     * 初始显示时是否将每月的天数显示全
     *
     * @param dayClear true从1号-30（31号）都显示   false从指定的天开始显示
     */
    public void setDayClear(boolean dayClear) {
        this.dayClear = dayClear;
    }

    /**
     * 初始显示时是否将小时数（00-23）显示全
     *
     * @param hourClear
     */
    public void setHourClear(boolean hourClear) {
        this.hourClear = hourClear;
    }

    /**
     * 初始显示时是否将分钟数（00-59）显示全
     *
     * @param minClear
     */
    public void setMinClear(boolean minClear) {
