 ...
 */
public class Coupon2Adapter extends RecyclerView.Adapter<Coupon2Adapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public Coupon2Adapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
