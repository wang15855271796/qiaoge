...
public class PickUtils {
  ...
  /* public static void initPickView(Context context) {
     ...
     * @param context
     */
    public static void showSinglePickView(Context context, final List<String> list, String title, final PickCityUtil.ChoosePositionListener listener) {
     ...
     * @param context
     */
    public static void showSinglePickViewTwo(Context context, final List<String> list, String title, final PickCityUtil.ChoosePositionListener listener) {
     ...
     * @param context
     */
    public static void showDoublePickView(Context context, final List<String> list1, final List<List<String>> list2, String title, final PickCityUtil.ChooseDPositionListener listener) {
