...
//              new MarginLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));//这个构造方法所然能使用但是编译器会报错
            ...
            final LinearLayout ll_del = (LinearLayout)childView.findViewById(R.id.ll_del);
            final ImageView iv_comment_image = (ImageView)childView.findViewById(R.id.iv_comment_image);
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(FlowTagLayout.this, ll_del, j);
                        }
...
//                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, ll_del, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, ll_del, list);
                        }
                    }
                }
            });
            iv_comment_image.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(FlowTagLayout.this, iv_comment_image, j);
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_SINGLE) {
                        //判断状态  禁止取消
//                        if (mCheckedTagArray.get(j)) {
...
//                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, iv_comment_image, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this,iv_comment_image, list);
                        }
                    }
                }
            });
