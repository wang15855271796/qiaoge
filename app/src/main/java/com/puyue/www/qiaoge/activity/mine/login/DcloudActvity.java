...
/**
 * Created by ${王涛} on 2019/10/15
 */
public class DcloudActvity extends Activity implements IActivityDelegate {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mEntryProxy == null) {
            ...
            // 创建5+内核运行事件监听
            WebappModeListener wm = new WebappModeListener(this, rootView);
            // 初始化5+内核
    ...
    public void onBackPressed() {
        boolean _ret = mEntryProxy != null && mEntryProxy.onActivityExecute(this, ISysEventListener.SysEventType.onKeyUp, new Object[]{KeyEvent.KEYCODE_BACK, null});
...
class WebappModeListener implements ICore.ICoreStatusListener, IOnCreateSplashView {
    ...
    public Object onCreateSplash(Context pContextWrapper) {
        ...
        splashView.setBackgroundResource(R.mipmap.ic_splash_three);
