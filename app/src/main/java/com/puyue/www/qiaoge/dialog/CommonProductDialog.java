...
import com.puyue.www.qiaoge.adapter.CommonProductItemAdapter;
 ...
 */
public class CommonProductDialog extends Dialog implements View.OnClickListener{
    Context context;
    public View view;
    String productName;
    ...
    public void getTotal(UpDateNumEvent4 upDateNumEvent) {
        getCartNum();
    }
    /**
     * 获取角标数据
