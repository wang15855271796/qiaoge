 ...
 */
public class AddressAdapters extends BaseQuickAdapter<AddressModel.DataBean, BaseViewHolder> {
    private OnEventClickListener mOnEventClickListener;

    public AddressAdapters(int layoutResId, @Nullable List<AddressModel.DataBean> data) {
